...
% Avoid fancyhdr warning about \headheight
...
% Usage: \screenshotfigure{web\_home.png}{Home dashboard (web UI)}
\providecommand{\screenshotfigure}[2]{%
  \begin{figure}[!ht]
    \centering
    \IfFileExists{#1}{%
...
\input{chapters/02_subject}
\input{chapters/04_data_sources}
\input{chapters/03_dw_design}
\input{chapters/05_etl_process}
\input{chapters/06_implementation}
\input{chapters/07_restitution_analysis}
